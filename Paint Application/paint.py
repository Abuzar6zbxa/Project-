...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.paint_tools = Frame(self.root,width=100,height=900,relief=RIDGE,borderwidth=2)
        ...
        self.c = Canvas(self.root, bg='white', width=1000, height=600,relief=RIDGE,borderwidth=0)
